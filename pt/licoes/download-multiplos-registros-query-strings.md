...
-   Old Bailey Online API (<https://www.oldbaileyonline.org/static/DocAPI.jsp>)
-   Melhor maneira de criar um diretório para gravação de ficheiros, se ele não existir, usando Python? (<https://stackoverflow.com/questions/273192/python-best-way-to-create-directory-if-it-doesnt-exist-for-file-write>)

...
*	É possível verificar que esta união funcionou dando um clique com o lado esquerdo do mouse na camada shapefile e selecionando _Abrir Tabela de Atributos_. Perceba que `AlumniCounties_Count Place of Origin` está disponível agora como uma das colunas na camada de formatos de condados, junto de diversos códigos e números de ID que fazem parte do shapefile que fez o download.
 ...
 {% include figure.html filename="pt-tr-geocodificando-qgis-02.png" alt="Janela Adicionar união de vetor cEm Unir camadas está selecionado CondadosExAlunos,  em Unir Campo está selecionado Etiquetas da Fileira e em Campo Alvo está selecionado NOME." caption="Figura 2: Caixa de diálogo dos campos unidos e o vetor" %}
...
{% include figure.html filename="pt-tr-geocodificando-qgis-03.png" alt="Janela Propriedades da camada - UKDefinitionA - Simbologia com a opção de estilo Graduado selecionado. O Valor representado é CondadosExAlunos_Numero de originarios, estando escolhido um gradiente de cores de branco a azul escuro com 5 classes." caption="Figura 3: A aba Simbologia mostrando os valores classificados com base nos campos unidos da tabela, na camada vetorial" %}
...
- [Association of British Counties Gazetteer](https://www.gazetteer.org.uk/index.php) (em inglês) (dados disponíveis para compra)
...
* Faça o download de um shapefile contendo polígonos dos condados históricos da Inglaterra e do País de Gales em [https://www.county-borders.co.uk/](https://www.county-borders.co.uk/) (em inglês) (selecione a definição A e o OSGB).
...
{% include figure.html filename="pt-tr-geocodificando-qgis-04.png" alt="Janela Centroides, estando selecionada como camada de entrada UKDefinition A EPSG: 27700." caption="Figura 4: Caixa de diálogo Centróide dos polígonos e o seu resultado" %}
...
{% include figure.html filename="pt-tr-geocodificando-qgis-05.png" alt="Janela Salvar Camada Vetorial como... estando escolhido o formato Valor Separado Por Vírgula (CSV), o nome do arquivo CondadosXY e o SRC EPSG: 27700 - OSGB36 / British National Grid." caption="Figura 5: A caixa de diálogo Salvar Camada Vetorial Como configurada para exportar um gazetteer CSV" %}
...
* Inspecione cada um para refrescar a memória acerca dos conteúdos das colunas.
 ...
 {% include figure.html filename="pt-tr-geocodificando-qgis-06.png" alt="Janela Copiar tabela, estando selecionado como Nome da Tabela Ex-Alunos." caption="Figura 6: Copiar uma tabela para o LibreOffice Base" %}
...
{% include figure.html filename="pt-tr-geocodificando-qgis-07.png" alt="Janela Geocod.odb: Consulta1 - LibreOffice Base: Editor de consulta', que mostra uma tabela relacional e a consulta realizada." caption="Figura 7: O design da consulta finalizado, no LibreOffice Base, mostrando a relação entre as tabelas e a grade detalhando os campos que serão visíveis no produto final" %}
...
{% include figure.html filename="pt-tr-geocodificando-qgis-08.png" alt="Janela Propriedades da camada - GeocodExAlunos - Simbologia' com a opção Deslocamento de ponto selecionada." caption="Figura 8: A aba Simbologia nas propriedades de camadas, exibindo o estilo Deslocamento de ponto, representando pontos que se sobrepõem na mesma localização" %}
...
{% include figure.html filename="pt-tr-geocodificando-qgis-09.png" alt="Janela do Serviço Online de Geocodificação do plugin MMQGIS." caption="Figura 9: A caixa de diálogo Serviço Online de Geocodificação do plugin MMQGIS" %}

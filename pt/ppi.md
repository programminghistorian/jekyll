...
As taxas são anuais e consideramos a contagem a partir da data do primeiro pagamento. Os valores são definidos em outubro de cada ano. Faça o download da nossa brochura para apoiadores, saiba mais e comece hoje a apoiar o nosso trabalho: [GBP](/assets/ipp-info/support-ph-gbp-2026-7.pdf), [USD](/assets/ipp-info/support-ph-usd-2026-7.pdf), [EUR](/assets/ipp-info/support-ph-eur-2026-7.pdf), [CAD](/assets/ipp-info/support-ph-cad-2026-7.pdf), ou [AUD](/assets/ipp-info/support-ph-aud-2026-7.pdf). Para uma cotação em outra moeda, por favor, envie um e-mail para [Anisa Hawes, Gestora de publicações](mailto:admin@programminghistorian.org).

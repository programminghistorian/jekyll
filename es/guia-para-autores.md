...
Si tienes una idea para una nueva lección, completa el [formulario de propuestas](/assets/forms/convocatoria-de-propuestas.txt) y [envíalo al Jefe de redacción, Jennifer Isasi](mailto:espanol@programminghistorian.org) o a nuestra [directora de publicaciones, Anisa Hawes](admin@programminghistorian.org).

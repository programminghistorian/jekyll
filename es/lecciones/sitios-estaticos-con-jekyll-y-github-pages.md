...
<div class="alert alert-warning">
Si configuras un dominio personalizado con tu sitio web alojado en GitHub Pages, para evitar un fallo de seguridad conocido, asegúrate de leer y seguir los pasos de <a href='https://docs.github.com/en/pages/configuring-a-custom-domain-for-your-github-pages-site/verifying-your-custom-domain-for-github-pages'>la documentación de GitHub</a> para verificar tu dominio y evitar el uso de registros DNS comodín.
</div>

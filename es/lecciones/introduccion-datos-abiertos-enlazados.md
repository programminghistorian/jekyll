...
El punto de entrada (*endpoint*) de consulta SPARQL que yo uso se llama [snorql](https://dbpedia.org/snorql/). Estos puntos de entrada a veces parecen desconectarse, por lo que, si ese fuera el caso, busca *dbpedia sparql* en internet para encontrar un reemplazo similar.

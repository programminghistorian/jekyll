...
- [internetarchive Python module](https://pypi.python.org/pypi/internetarchive)
...
- [Dublin Core metadata](https://archive.org/download/lettertowilliaml00doug/lettertowilliaml00doug_dc.xml)
- [MARCXML metadata](https://archive.org/download/lettertowilliaml00doug/lettertowilliaml00doug_marc.xml)
...
- [eBook and Texts collection](https://archive.org/details/texts)
- [how items and item URLs are structured](https://blog.archive.org/2011/03/31/how-archive-org-items-are-structured/)
...
- [search the Archive using the Python module](https://internetarchive.readthedocs.io/en/latest/quickstart.html#searching)
...
- [pymarc GitHub repo](https://github.com/edsu/pymarc)
- [functions for working with MARC XML records](https://github.com/edsu/pymarc/blob/master/pymarc/marcxml.py)

...
Since all *Programming Historian* lessons are written in Markdown, we can examine these files in StackEdit too. From the [StackEdit](https://stackedit.io), click on "Start Writing" in the upper bar. Then copy and paste the raw text from the lesson "Intro to Bash" in the editor:

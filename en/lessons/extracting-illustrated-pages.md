...
- `requests` ([Install docs](https://requests.readthedocs.io/en/latest/user/install/#install)) [creator recommends `pipenv` installation; for `pip` install see [PyPI](https://pypi.org/project/requests/)]
...
Anaconda has a handy [cheat sheet](https://web.archive.org/web/20190115051900/https://conda.io/docs/_downloads/conda-cheatsheet.pdf) for frequently used commands.

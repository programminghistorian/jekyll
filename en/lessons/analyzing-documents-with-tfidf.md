...
- Install the Python 3 version of Anaconda. Installing Anaconda is covered in [Text Mining in Python through the HTRC Feature Reader](/en/lessons/text-mining-with-extracted-features). This will install Python 3.6 (or higher), the Scikit-Learn library (which we will use for __tf-idf__), and the dependencies needed to run a Jupyter Notebook.   

...
In order to help you get started with nanDECK and Tabletop Simulator, I have made available a starter set of files for you to build upon, which you can [download from GitHub](/assets/designing-a-timeline-tabletop-simulator/designing-a-timeline-tabletop-simulator.zip). It contains two sub-folders, one named `nanDECK` and the other named `Tabletop-Simulator`.

The `nanDECK` sub-folder includes:
...
In the [starter set of files](/assets/designing-a-timeline-tabletop-simulator/designing-a-timeline-tabletop-simulator.zip) you'll find a sub-folder called `Tabletop-Simulator`. It contains:

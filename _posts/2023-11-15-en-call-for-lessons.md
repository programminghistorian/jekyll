...
We've set up [a Google Form](https://forms.gle/jCq8ttGQeMSEt5GL8) which you can submit directly online. There's also [a plain-text version](LINK) which you can [send to us by email](mailto:english@programminghistorian.org), if you prefer. The form has twelve questions.

...
{% include figure.html filename="distant-reading-01.png" caption="Screenshots of a distant reading of the US Department of Labor’s Annual Report on Immigration, 1910, conducted with [VoyantTools.org](http://voyant-tools.org/)" %}{% include figure.html filename="distant-reading-02.png" %}

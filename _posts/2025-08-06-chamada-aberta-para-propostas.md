---
title: Chamada Aberta para Propostas (edição em português)
authors:
- Eric Brasil  
- Anisa Hawes
layout: post
...
**Encerramento das submissões**: 31 de dezembro 2025 (_prazo prorrogado_)
...
Caso tenha dúvidas, entre em contato com o Editor-Geral da edição em português do *Programming Historian*, [Eric Brasil](mailto:portugues@programminghistorian.org), ou com nossa Gerente de Publicações, [Anisa Hawes](mailto:admin@programminghistorian.org).

...
- Ajudar leitores a adquirir conhecimentos práticos
- Desenvolver suas habilidades de escrita técnica
- Transformar a prática da investigação em ensino

Saiba mais: [tinyurl.com/ph-chamada-aberta](https://tinyurl.com/ph-chamada-aberta)
...
- Empower readers with knowledge of a digital method or tool
- Hone your technical writing skills
- Transform your research practice into teaching

Learn more: [tinyurl.com/open-call-2025-blog](https://tinyurl.com/open-call-2025-blog)
...
[Introduction to Encoding Texts in TEI (Part 1)](https://doi.org/10.46430/phen0129)
  - This lesson teaches you the basics of using TEI-XML to encode texts, and demonstrates how to create a minimal TEI document. 

- Pascal Martinolli   
[Enrichir ses données avec le processus de réconciliation d’OpenRefine](https://doi.org/10.46430/phfr0038)
  - Cette leçon vous initie à enrichir un jeu de données de recherche avec d’autres données liées provenant de sources externes telles que Wikidata. Cet enrichissement, basé sur un processus nommé « réconciliation », est géré par OpenRefine.

- Anthony Picón Rodríguez e Miguel Cuadros, traduzido por Bernardo de Souza   
[Introdução ao Map Warper](https://doi.org/10.46430/phpt0055)
...
>
>Y bueno, esto no es una despedida. Seguiremos trabajando juntas de alguna forma. 

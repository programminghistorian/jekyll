...
Si vous pensez que vous savez comment corriger un problème dans une leçon, vous pouvez envisager de réaliser un fork de notre dépôt GitHub et de faire une demande d'extraction (pull request).

...
Nous demandons aux auteur(e)s, aux traducteurs et aux traductrices compléter [un formulaire de déclaration](/assets/forms/Droit-d-auteur-et-authorisation-de-publication.pdf) pour reconnaître le droit d'auteur et accorder l'autorisation de publier. Veuillez envoyer le formulaire [à notre assistante éditoriale](mailto:admin@programminghistorian.org). 

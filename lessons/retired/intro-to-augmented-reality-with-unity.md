...
retired: true
retirement-reason: |
  Unity recently changed several of its components, so this lesson was rendered out of date. An updated lesson on augmented reality in Unity is in process - stay tuned!

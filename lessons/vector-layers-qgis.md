...
-   Previous
    ...
    [Installing QGIS 2.0 and Adding Layers][1]

-   Next

    [Georeferencing in QGIS 2.0][2]
  ...
  [Click here to cancel reply.]: /lessons/vector-layers-qgis#respond
  [1]: http://programminghistorian.org/lessons/qgis-layers
  [2]: http://programminghistorian.org/lessons/georeferencing-qgis

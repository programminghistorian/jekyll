...
Network visualizations can help humanities scholars reveal hidden and complex patterns and structures in textual sources. This tutorial explains how to extract network data (of group of people, institutions, places, etc) historical sources through the use of non-technical methods developed in Qualitative Data Analysis (QDA) and Social Network Analysis (SNA) that can be used used in a variety of network visualization and analysis tools such as[ ](https://sites.google.com/site/ucinetsoftware/home)[*UCINET*](https://sites.google.com/site/ucinetsoftware/home),[ ](http://pajek.imfm.si/doku.php)[*Pajek*](http://pajek.imfm.si/doku.php),[ ](https://gephi.github.io/)[*Gephi*](https://gephi.github.io/),[ ](http://nodexl.codeplex.com/)[*NodeXL*](http://nodexl.codeplex.com/),[ ](http://visone.info/)[*visone*](http://visone.info/), or the platform-independent and particularly easy-to-use [*Palladio*](http://palladio.designhumanities.org/#/), which we will use in this tutorial.

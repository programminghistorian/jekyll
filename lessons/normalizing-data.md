...
### One Response to “Normalizing Data” {#comments}

1.  ![][] [Francesca Benatti][] says:

    [September 3, 2013 at 11:10 am][]

    Dear Programming Historian team,\
     I think the code to be added to obo.py contains an error in line
    6.\
     It reads return re.compile(r’W+’, re.UNICODE).split(text)\
     but it should be return re.compile(r’\\W+’,
    re.UNICODE).split(text)\
     Without the ‘\\’ before W+ it will not return a list.\
     After many futile attempts to run html-to-list1.py, I was able to
    solve the problem only because the correct code is included in the
    programming-historian3.zip files.
...
-   Next
  ...
  []: http://1.gravatar.com/avatar/f2044910b81c8194bd21dc6da2e87326?s=32&d=http%3A%2F%2F1.gravatar.com%2Favatar%2Fad516503a11cd5ca435acc9bb6523536%3Fs%3D32&r=G
  [Francesca Benatti]: http://rhymesontheroad.wordpress.com
  [September 3, 2013 at 11:10 am]: http://programminghistorian.org/lessons/normalizing-data#comment-13747
  [Reply]: /lessons/normalizing-data?replytocom=13747#respond
  [Click here to cancel reply.]: /lessons/normalizing-data#respond

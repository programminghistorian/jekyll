...
### 2 Responses to “Getting Started with Online Sources” {#comments}

1.  [WARC Files, Part Two: Using WARC Tools to Get Closer to that Needle
    « Ian Milligan][] says:

    [December 13, 2012 at 4:27 pm][]

    [...] an editor-at-large there, so I guess it’s us now?) over at the
    Programming Historian 2 have a lesson on setting it up and
    everything you’ll need to get started on that front. If you’re on a
    newer Mac at least, you should already have Python set up which you
    can [...]

    [Reply][]

2.  [Cleaning up a Google Book for text mining | clio 3 blog][] says:

    [December 18, 2012 at 5:07 am][]

    [...] includes the ability to execute a Python script right in your
    window. Programming Historian 2 has a method for setting that up.
    You can also, of course, test your scripts using the command [...]
...
Website
  ...
  [WARC Files, Part Two: Using WARC Tools to Get Closer to that Needle «
  Ian Milligan]: http://ianmilligan.ca/2012/12/13/warc-files-part-two-using-warc-tools/
  [December 13, 2012 at 4:27 pm]: http://programminghistorian.org/lessons/getting-started#comment-5979
  [Reply]: /lessons/getting-started?replytocom=5979#respond
  [Cleaning up a Google Book for text mining | clio 3 blog]: http://www.fredgibbs.net/clio3workspace/blog/google-book-text-mining/
  [December 18, 2012 at 5:07 am]: http://programminghistorian.org/lessons/getting-started#comment-6143
  [3]: /lessons/getting-started?replytocom=6143#respond
  [Click here to cancel reply.]: /lessons/getting-started#respond
